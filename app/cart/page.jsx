        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <div className="mt-8">
                ...
                {cart?.map((item) => (
                    ...
                    <button className="text-gray-600 transition hover:text-red-600" onClick={()=> deleteCartItemFromList(item?.id)}>
            ...
            <h2 className='text-gray-400 text-[12px] mt-10'>Note: All Items will be sent via Email</h2>
            </div>
