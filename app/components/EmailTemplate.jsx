	...
	<Html>
		...
		<Body style={main}>
			<Container style={container}>
				<Img
					src='https://res.cloudinary.com/dbbiout5y/image/upload/v1726440265/medium_next_a2cad37f9f.webp'
					width="420"
					height="300"
					alt="Koala"
					style={logo}
				...
				Thank you for purchasing on Ecommerce. Click on the button below to download all digital content.
				</Text>
